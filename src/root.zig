...
pub const DiagLabel = diagnostic.Label;
pub const renderDiagnostic = diagnostic.renderDiagnostic;
pub const renderDiagnosticColored = diagnostic.render;
pub const renderAll = diagnostic.renderAll;
pub const Palette = @import("style.zig").Palette;
pub const stderrPalette = @import("style.zig").forStderr;
