...
// into gabbrolld.dll so the compiler can link without spawning a 69 MB lld-link.exe
...
extern "C" __declspec(dllexport) int gabbro_lld_link_coff(int argc, const char **argv) {
